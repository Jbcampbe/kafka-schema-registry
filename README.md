...
import (
	...
	"github.com/Jbcampbe/kafka-schema-registry/kafka"
)
...
```golang
import "github.com/Jbcampbe/kafka-schema-registry/kafka"
```
...
Manual install:
```bash
go get -u github.com/Jbcampbe/kafka-schema-registry/kafka
```
